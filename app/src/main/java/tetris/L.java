...
class L extends Piece {
    ...
    protected Location[][] buildRotationLocations() {
        ...
        // rotationId 0
        rotationLocation[0][0] = new Location(2, 0);
        rotationLocation[1][0] = new Location(0, 1);
        rotationLocation[2][0] = new Location(1, 1);
        rotationLocation[3][0] = new Location(2, 1);
        // rotationId 1
        rotationLocation[0][1] = new Location(0, 0);
        rotationLocation[1][1] = new Location(0, 1);
        rotationLocation[2][1] = new Location(0, 2);
        rotationLocation[3][1] = new Location(1, 2);
        // rotationId 2
        rotationLocation[0][2] = new Location(0, 0);
        rotationLocation[1][2] = new Location(1, 0);
        rotationLocation[2][2] = new Location(2, 0);
        rotationLocation[3][2] = new Location(0, 1);
        // rotationId 3
        rotationLocation[0][3] = new Location(0, 0);
        rotationLocation[1][3] = new Location(1, 0);
        rotationLocation[2][3] = new Location(1, 1);
        rotationLocation[3][3] = new Location(1, 2);
