...
class Slash extends Piece {
    ...
    protected Location[][] buildRotationLocations() {
        Location[][] rotationLocations = new Location[3][4];
        // rotationId 0
        rotationLocations[0][0] = new Location(2, 0);
        rotationLocations[1][0] = new Location(1, 1);
        rotationLocations[2][0] = new Location(0, 2);
        // rotationId 1
        rotationLocations[0][1] = new Location(2, 0);
        rotationLocations[1][1] = new Location(1, 1);
        rotationLocations[2][1] = new Location(0, 2);
        // rotationId 2
        rotationLocations[0][2] = new Location(2, 0);
        rotationLocations[1][2] = new Location(1, 1);
        rotationLocations[2][2] = new Location(0, 2);
        // rotationId 3
        rotationLocations[0][3] = new Location(2, 0);
        rotationLocations[1][3] = new Location(1, 1);
        rotationLocations[2][3] = new Location(0, 2);
