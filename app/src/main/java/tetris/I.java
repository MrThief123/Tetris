...
class I extends Piece {
    ...
    protected Location[][] buildRotationLocations() {
        ...
        rotationLocations[2][0] = new Location(2, 0);
        rotationLocations[3][0] = new Location(3, 0);
        // rotationId 1
        rotationLocations[0][1] = new Location(0, 0);
        rotationLocations[1][1] = new Location(0, 1);
        rotationLocations[2][1] = new Location(0, 2);
        rotationLocations[3][1] = new Location(0, 3);
        // rotationId 2
        rotationLocations[0][2] = new Location(0, 0);
        rotationLocations[1][2] = new Location(1, 0);
        rotationLocations[2][2] = new Location(2, 0);
        rotationLocations[3][2] = new Location(3, 0);
        // rotationId 3
        rotationLocations[0][3] = new Location(0, 0);
        rotationLocations[1][3] = new Location(0, 1);
        rotationLocations[2][3] = new Location(0, 2);
        rotationLocations[3][3] = new Location(0, 3);
